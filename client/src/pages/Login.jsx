export const Login = () => {
  ...
  return (
    <div className="flex  items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-700">
      <div className="bg-gray-800 w-2/5 h-96 flex flex-col items-center rounded-lg justify-start border border-gray-300">
        <div className="flext items-start ">
          <span className="flex font-satoshi font-bold h-20 text-cyan-400  text-3xl my-10  ">
            Login In
            <p className="text-orange-300 mx-2">Edtech-AI</p>
          </span>
        </div>
        <button
          onClick={handleLogin}
